...
const getLocalIp = () => {
    ...
    //console.log(Object.keys(interfaces)); //Возвращает ключи объекта
};

//console.log(getLocalIp()); //internal: true - это доступный только на устройство, internal: false - это доступен везде в сети
...
server.listen(PORT, '0.0.0.0'); //Стартуем с этого айпи, чтобы другие устройства могли зайти на сайт
console.log(`Облако запущено по адресу: http://${getLocalIp()}:${PORT}`);